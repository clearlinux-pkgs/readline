...
Source0  : https://mirrors.kernel.org/gnu/readline/readline-8.2.13.tar.gz
Source1  : https://mirrors.kernel.org/gnu/readline/readline-8.2.13.tar.gz.sig
...
%setup -q -n readline-8.2.13
cd %{_builddir}/readline-8.2.13
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
%patch -P 4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722877176
unset LD_AS_NEEDED
